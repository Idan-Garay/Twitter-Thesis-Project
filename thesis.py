# for macos: python3 -m pip install tweet-preprocessor snscrape contractions lingua-language-detector langdetect advertools wordcloud vaderSentiment pip install langdetect numpy advertools contractions nltk scikit-learn snscrape
# for windows: python -m pip install tweet-preprocessor snscrape contractions lingua-language-detector langdetect advertools wordcloud vaderSentiment pip install langdetect numpy advertools contractions nltk scikit-learn snscrape
...
# dataset with preprocessed in another column called 'Clean'
